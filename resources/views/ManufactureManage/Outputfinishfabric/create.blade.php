...
@section('main')
    <h1>添加成布生产质量信息(Add Production and Quantity of Finishfabric Information)</h1>
    <hr/>
    {{--'outputdate'=>date('Y-m-d',time()-5*60*60),--}}
    {!! Form::open(['url' => 'ManufactureManage/Outputfinishfabric', 'class' => 'form-horizontal','id'=>'frmAddprd_quan']) !!}
        @include('ManufactureManage.Outputfinishfabric._form',
            [
                ...
                'checkdate'=>date('Y-m-d',time()-5*60*60),
    ...
    <script type="text/javascript">
        jQuery(document).ready(function(e) {
            ...
            $("#btnSubmit1").click(function () {
                $.ajax({
                    type: "POST",
                    url: "{{url('/ManufactureManage/Outputfinishfabric/storenew')}}",
