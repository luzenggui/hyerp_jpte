<div class="form-group">
    ...
    <div class='col-xs-4 col-sm-4'>
        @if(isset($gradecffabric))
            {!! Form::text('pattern', $gradecffabric->processinfo->pattern, ['class' => 'form-control', $attr,'data-toggle' => 'modal', 'data-target' => '#selectProcessinfoModal']) !!}
        @else
...
<div class="form-group">
    ...
    <div class='col-xs-4 col-sm-4'>
        @if(isset($gradecffabric))
            {!! Form::date('diliverydate', $gradecffabric->processinfo->diliverydate, ['class' => 'form-control','readonly', $attr]) !!}
        @else
    ...
    <div class='col-xs-4 col-sm-4'>
        @if(isset($gradecffabric))
            {!! Form::text('contractno', $gradecffabric->processinfo->contractno, ['class' => 'form-control','readonly', $attr]) !!}
        @else
...
<div class="form-group">
    ...
    <div class='col-xs-4 col-sm-4'>
        @if(isset($gradecffabric))
            {!! Form::text('specification', $gradecffabric->processinfo->specification, ['class' => 'form-control','readonly', $attr]) !!}
        @else
    ...
    <div class='col-xs-4 col-sm-4'>
        @if(isset($gradecffabric))
            {!! Form::text('width', $gradecffabric->processinfo->width, ['class' => 'form-control','readonly', $attr]) !!}
        @else
